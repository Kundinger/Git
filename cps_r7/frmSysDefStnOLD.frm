...
Begin VB.Form frmSysDefStn 
   ...
   Begin VB.Frame frmOptodef 
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmSysDefStn.frx":7425
         Left            =   1200
         List            =   "frmSysDefStn.frx":7445
         Style           =   2  'Dropdown List
         TabIndex        =   26
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmSysDefStn.frx":747A
         Left            =   1200
         List            =   "frmSysDefStn.frx":749A
         Style           =   2  'Dropdown List
         TabIndex        =   25
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   1920
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmSysDefStn.frx":74CF
         Left            =   1200
         List            =   "frmSysDefStn.frx":74EF
         Style           =   2  'Dropdown List
         TabIndex        =   24
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   2280
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   3
         ItemData        =   "frmSysDefStn.frx":7524
         Left            =   1200
         List            =   "frmSysDefStn.frx":7544
         Style           =   2  'Dropdown List
         TabIndex        =   23
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   2640
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   4
         ItemData        =   "frmSysDefStn.frx":7579
         Left            =   1200
         List            =   "frmSysDefStn.frx":7599
         Style           =   2  'Dropdown List
         TabIndex        =   22
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   3000
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   6
         ItemData        =   "frmSysDefStn.frx":7623
         Left            =   1200
         List            =   "frmSysDefStn.frx":7643
         Style           =   2  'Dropdown List
         TabIndex        =   20
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   3720
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   7
         ItemData        =   "frmSysDefStn.frx":7678
         Left            =   1200
         List            =   "frmSysDefStn.frx":7698
         Style           =   2  'Dropdown List
         TabIndex        =   19
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   4080
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   8
         ItemData        =   "frmSysDefStn.frx":76CD
         Left            =   1200
         List            =   "frmSysDefStn.frx":76ED
         Style           =   2  'Dropdown List
         TabIndex        =   18
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   4440
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   9
         ItemData        =   "frmSysDefStn.frx":7722
         Left            =   1200
         List            =   "frmSysDefStn.frx":7742
         Style           =   2  'Dropdown List
         TabIndex        =   17
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   4800
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   10
         ItemData        =   "frmSysDefStn.frx":7777
         Left            =   1200
         List            =   "frmSysDefStn.frx":7797
         Style           =   2  'Dropdown List
         TabIndex        =   16
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   5160
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   12
         ItemData        =   "frmSysDefStn.frx":7821
         Left            =   1200
         List            =   "frmSysDefStn.frx":7841
         Style           =   2  'Dropdown List
         TabIndex        =   14
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   5880
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   13
         ItemData        =   "frmSysDefStn.frx":7876
         Left            =   1200
         List            =   "frmSysDefStn.frx":7896
         Style           =   2  'Dropdown List
         TabIndex        =   13
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   6240
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   14
         ItemData        =   "frmSysDefStn.frx":78CB
         Left            =   1200
         List            =   "frmSysDefStn.frx":78EB
         Style           =   2  'Dropdown List
         TabIndex        =   12
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   6600
      ...
      Begin VB.ComboBox ModuleType 
         ...
         Height          =   330
         Index           =   15
         ItemData        =   "frmSysDefStn.frx":7920
         Left            =   1200
         List            =   "frmSysDefStn.frx":7940
         Style           =   2  'Dropdown List
         TabIndex        =   11
         ToolTipText     =   "Alphanumeric Entry"
         Top             =   6960
   ...
   Begin VB.Frame frmSelector 
      ...
      Begin VB.CommandButton cmdDown 
         DisabledPicture =   "frmSysDefStn.frx":8077
         DownPicture     =   "frmSysDefStn.frx":8779
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Dim idx, slot, maxslot As Integer
    ...
    If DefStn > 0 Then
        ...
        If Def_Stn.Type = STN_REGLIVE_TYPE Then optRegLive = True
        If Def_Stn.Type = STN_ORVR2LIVE_TYPE Then optORVR2Live = True
        ...
        If Def_Stn.Type = STN_LIVEFUEL_TYPE _
            Or Def_Stn.Type = STN_REGLIVE_TYPE _
            Or Def_Stn.Type = STN_ORVR2LIVE_TYPE Then
...
Dim whichADF As Integer
    ...
    If chkADF.Value = cYES Then
        If (chkVapor.Value = cNO And chkHeater.Value = cNO And chkFuelStorage.Value = cNO) Then
            whichADF = 1        '(Mark IV)
        ElseIf (chkVapor.Value = cYES And chkHeater.Value = cYES And chkFuelStorage.Value = cNO) Then
            whichADF = 12       '(Mahle)
        ElseIf (chkVapor.Value = cYES And chkHeater.Value = cYES And chkFuelStorage.Value = cYES) Then
            whichADF = 20       '(Stant)
        ElseIf (chkVapor.Value = cYES And chkHeater.Value = cNO And chkFuelStorage.Value = cYES) Then
...
If CheckPass("9", True) Then
    ...
    If DefStn > 0 Then
        ...
        End If
        If optORVR2Live Then
            Def_Stn.Type = STN_ORVR2LIVE_TYPE
            Def_Stn.ADF_StnNum = 0
            Def_Stn.ADF_TANKTYPE = 0
            ' Butane MFC Density Multiplier
            '   max     1.1
        ...
        Select Case Def_Stn.Type
            Case STN_REGULAR_TYPE, STN_ORVR_TYPE
                ...
                End If
            Case STN_REGLIVE_TYPE
                If Def_Stn.ButMfcDensityMult <> STN_INFO(DefStn).ButMfcDensityMult Then
                    Write_ELog "Station #" & Format(DefStn, "0") & " Butane MFC Density Multiplier changed to " & Format(Def_Stn.ButMfcDensityMult, "0.0##")
                End If
            Case STN_ORVR2_TYPE, STN_ORVR2LIVE_TYPE
                If Def_Stn.ButMfcDensityMult <> STN_INFO(DefStn).ButMfcDensityMult Then
                    Write_ELog "Station #" & Format(DefStn, "0") & " Butane MFC Density Multiplier changed to " & Format(Def_Stn.ButMfcDensityMult, "0.0##")
                End If
