...
' txtDbgElapsed.Visible = True
' txtDbgElapsed.text = IIf(AnyMoreLiveFuelLoads(Index, index2), "More LF Loads ToDo", "All LF Loads Done")
...
txtDebug1.Visible = False
    ...
    '**************************************************************
    ChgErrModule 89, 2
    txtDspStn.text = STN_INFO(Index).Abrev
