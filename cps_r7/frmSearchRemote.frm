...
Begin VB.Form frmSearchRemote 
   ...
   Begin MSDataGridLib.DataGrid dgRemoteTasks 
      Bindings        =   "frmSearchRemote.frx":57E2
      Height          =   5935
      Left            =   120
      TabIndex        =   2
      Top             =   120
   ...
   Begin Threed.SSPanel pbxBottom 
      ...
      Begin VB.CommandButton cmdDisplayReadyTasks 
         Caption         =   "Ready Tasks"
         DisabledPicture =   "frmSearchRemote.frx":57FF
         DownPicture     =   "frmSearchRemote.frx":6441
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   13800
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":7083
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   120
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdDisplayAllTasks 
         Caption         =   "All Tasks"
         DisabledPicture =   "frmSearchRemote.frx":7CC5
         DownPicture     =   "frmSearchRemote.frx":8907
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   13800
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":9549
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   3060
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdDisplayActiveTasks 
         ...
         DisabledPicture =   "frmSearchRemote.frx":A18B
         DownPicture     =   "frmSearchRemote.frx":ADCD
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   13800
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":BA0F
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   1590
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdLoad 
         ...
         DisabledPicture =   "frmSearchRemote.frx":C651
         DownPicture     =   "frmSearchRemote.frx":D293
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":DED5
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   3300
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdStnDn 
         DisabledPicture =   "frmSearchRemote.frx":EB17
         DownPicture     =   "frmSearchRemote.frx":F219
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":F91B
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmdStnUp 
         ...
         Left            =   2205
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":1001D
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Next"
         Top             =   1200
      ...
      Begin VB.CommandButton cmdShiftDn 
         DisabledPicture =   "frmSearchRemote.frx":1071F
         DownPicture     =   "frmSearchRemote.frx":10E21
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   3120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":11523
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Previous"
         Top             =   1200
      ...
      Begin VB.CommandButton cmdShiftUp 
         ...
         Left            =   5325
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":11C25
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Next"
         Top             =   1200
      ...
      Begin VB.CommandButton cmdStart 
         Caption         =   "Start Test"
         DisabledPicture =   "frmSearchRemote.frx":12327
         DownPicture     =   "frmSearchRemote.frx":12F69
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   3000
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":13BAB
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   3300
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSelect 
         Caption         =   "Select Task"
         DisabledPicture =   "frmSearchRemote.frx":147ED
         DownPicture     =   "frmSearchRemote.frx":1542F
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchRemote.frx":16071
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   120
         UseMaskColor    =   -1  'True
