Attribute VB_Name = "Module21"
      ...
      Public Sub PrintPictureToFitPage(Prn As Printer, Pic As Picture)
         ...
         PrnWidth = Prn.ScaleX(Prn.ScaleWidth - 1080, Prn.ScaleMode, vbHiMetric)
         PrnHeight = Prn.ScaleY(Prn.ScaleHeight - 1080, Prn.ScaleMode, vbHiMetric)
         ...
         If PicRatio >= PrnRatio Then
            ...
            PrnPicHeight = Prn.ScaleY(PrnWidth / PicRatio, vbHiMetric, _
               Prn.ScaleMode)
            ' Center the picture left/right & Leave a blank area at the top
            PrnX1 = 1080
            PrnY1 = 1080
         Else
            ...
            PrnPicWidth = Prn.ScaleX(PrnHeight * PicRatio, vbHiMetric, _
               Prn.ScaleMode)
            ' Center the picture left/right & Leave a blank area at the top
            PrnX1 = (Prn.ScaleWidth - PrnPicWidth) / 2
            PrnY1 = 1080
         End If

         ' Print the picture using the PaintPicture method.
         Prn.PaintPicture Pic, PrnX1, PrnY1, PrnPicWidth, PrnPicHeight
      End Sub
      '--------------------------------------------------------------------
