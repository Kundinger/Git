...
Begin VB.Form frmSearchTom 
   ...
   Begin VB.CommandButton cmdDisplayAllTasks 
      Caption         =   "All Tasks"
      DisabledPicture =   "frmSearchTOM.frx":0000
      DownPicture     =   "frmSearchTOM.frx":0C42
      BeginProperty Font 
   ...
   Begin VB.CommandButton cmdDisplayActiveTasks 
      ...
      DisabledPicture =   "frmSearchTOM.frx":24C6
      DownPicture     =   "frmSearchTOM.frx":3108
      BeginProperty Font 
         Name            =   "Microsoft Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.CommandButton cmdDisplayReadyTasks 
      Caption         =   "Ready Tasks"
      DisabledPicture =   "frmSearchTOM.frx":498C
      DownPicture     =   "frmSearchTOM.frx":55CE
      BeginProperty Font 
         Name            =   "Microsoft Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin MSDataGridLib.DataGrid dgTomTasks 
      Bindings        =   "frmSearchTOM.frx":6E52
      Height          =   6000
      Left            =   119
      TabIndex        =   2
      Top             =   0
   ...
   Begin Threed.SSPanel pbxBottom 
      ...
      Begin VB.CommandButton cmdSelect 
         Caption         =   "Select Task"
         DisabledPicture =   "frmSearchTOM.frx":6E6C
         DownPicture     =   "frmSearchTOM.frx":7AAE
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CommandButton cmdStart 
         Caption         =   "Start Test"
         DisabledPicture =   "frmSearchTOM.frx":9332
         DownPicture     =   "frmSearchTOM.frx":9F74
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CommandButton cmdShiftDn 
         DisabledPicture =   "frmSearchTOM.frx":BEFA
         DownPicture     =   "frmSearchTOM.frx":C5FC
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CommandButton cmdStnDn 
         DisabledPicture =   "frmSearchTOM.frx":DB02
         DownPicture     =   "frmSearchTOM.frx":E204
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CommandButton cmdLoad 
         ...
         DisabledPicture =   "frmSearchTOM.frx":F008
         DownPicture     =   "frmSearchTOM.frx":FC4A
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmSearchTOM.frx":1088C
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   3420
         UseMaskColor    =   -1  'True
