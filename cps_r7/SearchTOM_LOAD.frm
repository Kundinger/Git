...
Begin VB.Form frmTomLoad 
   ...
   Begin VB.CommandButton cmdDisplayAllTasks 
      Caption         =   "All Tasks"
      DisabledPicture =   "SearchTOM_LOAD.frx":0000
      DownPicture     =   "SearchTOM_LOAD.frx":0C42
      BeginProperty Font 
      ...
      Left            =   13800
      MaskColor       =   &H00FFFFFF&
      Picture         =   "SearchTOM_LOAD.frx":1884
      Style           =   1  'Graphical
      TabIndex        =   25
      Top             =   9000
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton cmdDisplayActiveTasks 
      ...
      DisabledPicture =   "SearchTOM_LOAD.frx":24C6
      DownPicture     =   "SearchTOM_LOAD.frx":3108
      BeginProperty Font 
         Name            =   "Microsoft Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Left            =   13800
      MaskColor       =   &H00FFFFFF&
      Picture         =   "SearchTOM_LOAD.frx":3D4A
      Style           =   1  'Graphical
      TabIndex        =   24
      Top             =   7560
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton cmdDisplayReadyTasks 
      Caption         =   "Ready Tasks"
      DisabledPicture =   "SearchTOM_LOAD.frx":498C
      DownPicture     =   "SearchTOM_LOAD.frx":55CE
      BeginProperty Font 
         Name            =   "Microsoft Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Left            =   13800
      MaskColor       =   &H00FFFFFF&
      Picture         =   "SearchTOM_LOAD.frx":6210
      Style           =   1  'Graphical
      TabIndex        =   23
      Top             =   6120
      UseMaskColor    =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid dgRemoteTasks 
      Bindings        =   "SearchTOM_LOAD.frx":6E52
      Height          =   5940
      Left            =   0
      TabIndex        =   2
      Top             =   0
   ...
   Begin Threed.SSPanel pbxBottom 
      ...
      Begin VB.CommandButton cmdSelect 
         Caption         =   "Select Task"
         DisabledPicture =   "SearchTOM_LOAD.frx":6E6F
         DownPicture     =   "SearchTOM_LOAD.frx":7AB1
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "SearchTOM_LOAD.frx":86F3
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   120
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdStart 
         Caption         =   "Start Test"
         DisabledPicture =   "SearchTOM_LOAD.frx":9335
         DownPicture     =   "SearchTOM_LOAD.frx":9F77
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   3000
         MaskColor       =   &H00FFFFFF&
         Picture         =   "SearchTOM_LOAD.frx":ABB9
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   3300
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdShiftUp 
         ...
         Left            =   5325
         MaskColor       =   &H00FFFFFF&
         Picture         =   "SearchTOM_LOAD.frx":B7FB
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Next"
         Top             =   1200
      ...
      Begin VB.CommandButton cmdShiftDn 
         DisabledPicture =   "SearchTOM_LOAD.frx":BEFD
         DownPicture     =   "SearchTOM_LOAD.frx":C5FF
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   3120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "SearchTOM_LOAD.frx":CD01
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton cmdStnUp 
         ...
         Left            =   2205
         MaskColor       =   &H00FFFFFF&
         Picture         =   "SearchTOM_LOAD.frx":D403
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Next"
         Top             =   1200
      ...
      Begin VB.CommandButton cmdStnDn 
         DisabledPicture =   "SearchTOM_LOAD.frx":DB05
         DownPicture     =   "SearchTOM_LOAD.frx":E207
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "SearchTOM_LOAD.frx":E909
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Previous"
         Top             =   1200
      ...
      Begin VB.CommandButton cmdLoad 
         ...
         DisabledPicture =   "SearchTOM_LOAD.frx":F00B
         DownPicture     =   "SearchTOM_LOAD.frx":FC4D
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
         ...
         Left            =   0
         MaskColor       =   &H00FFFFFF&
         Picture         =   "SearchTOM_LOAD.frx":1088F
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   3300
         UseMaskColor    =   -1  'True
...
Dim flag As Boolean
    ...
    StationCanister(CurTomTask.ActualStation, CurTomTask.ActualShift).WCVolume = CurTomTask.CanVolume
