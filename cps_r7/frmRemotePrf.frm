...
Begin VB.Form frmRemotePrf 
   Caption         =   "Remote Master Purge Profiles"
   ClientHeight    =   11100
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14835
   ...
   Begin MSAdodcLib.Adodc adoRemoteProfiles 
      Height          =   375
      Left            =   10800
      Top             =   9240
      Visible         =   0   'False
      ...
      _Version        =   393216
   End
   Begin MSAdodcLib.Adodc adoRemoteProfileSteps 
      Height          =   375
      Left            =   10800
      Top             =   9600
      Visible         =   0   'False
      ...
      _Version        =   393216
   End
   Begin MSDataGridLib.DataGrid dgRemoteProfiles 
      Bindings        =   "frmRemotePrf.frx":0000
      Height          =   4095
      Left            =   0
      TabIndex        =   0
      Top             =   0
      ...
      EndProperty
   End
   Begin MSDataGridLib.DataGrid dgRemoteProfileSteps 
      Bindings        =   "frmRemotePrf.frx":001A
      Height          =   5175
      Left            =   0
      TabIndex        =   1
      Top             =   4080
   ...
   End
End
Attribute VB_Name = "frmRemotePrf"
