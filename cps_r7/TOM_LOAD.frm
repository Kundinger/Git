...
Begin VB.Form frmTomLoad 
   ...
   Begin VB.CommandButton cmdDisplayAllTasks 
      Caption         =   "All Tasks"
      DisabledPicture =   "TOM_LOAD.frx":0000
      DownPicture     =   "TOM_LOAD.frx":0C42
      BeginProperty Font 
   ...
   Begin VB.CommandButton cmdDisplayActiveTasks 
      ...
      DisabledPicture =   "TOM_LOAD.frx":24C6
      DownPicture     =   "TOM_LOAD.frx":3108
      BeginProperty Font 
         Name            =   "Microsoft Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.CommandButton cmdDisplayReadyTasks 
      Caption         =   "Ready Tasks"
      DisabledPicture =   "TOM_LOAD.frx":498C
      DownPicture     =   "TOM_LOAD.frx":55CE
      BeginProperty Font 
         Name            =   "Microsoft Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin Threed.SSPanel pbxBottom 
      ...
      Begin VB.CommandButton cmdSelect 
         Caption         =   "Select Task"
         DisabledPicture =   "TOM_LOAD.frx":6E6F
         DownPicture     =   "TOM_LOAD.frx":7AB1
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CommandButton cmdStart 
         Caption         =   "Start Test"
         DisabledPicture =   "TOM_LOAD.frx":9335
         DownPicture     =   "TOM_LOAD.frx":9F77
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CommandButton cmdShiftDn 
         DisabledPicture =   "TOM_LOAD.frx":BEFD
         DownPicture     =   "TOM_LOAD.frx":C5FF
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CommandButton cmdStnDn 
         DisabledPicture =   "TOM_LOAD.frx":DB05
         DownPicture     =   "TOM_LOAD.frx":E207
         BeginProperty Font 
            Name            =   "Microsoft Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CommandButton cmdLoad 
         ...
         DisabledPicture =   "TOM_LOAD.frx":F00B
         DownPicture     =   "TOM_LOAD.frx":FC4D
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
