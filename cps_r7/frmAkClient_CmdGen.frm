...
Begin VB.Form frmAkClient_CmdGen 
   ...
   ClientTop       =   435
   ClientWidth     =   16740
   Icon            =   "frmAkClient_CmdGen.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9870
   ...
   Begin VB.CommandButton cmdStop 
      DisabledPicture =   "frmAkClient_CmdGen.frx":57E2
      Height          =   375
      Index           =   1
      Left            =   18840
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":5B24
      Style           =   1  'Graphical
      TabIndex        =   105
      Top             =   9000
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton cmdStart 
      DisabledPicture =   "frmAkClient_CmdGen.frx":5E66
      Height          =   375
      Index           =   1
      Left            =   18000
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":61A8
      Style           =   1  'Graphical
      TabIndex        =   104
      Top             =   9000
      UseMaskColor    =   -1  'True
   ...
   Begin VB.Frame frmFlows 
      ...
      End
      Begin VB.CommandButton cmdStop 
         DisabledPicture =   "frmAkClient_CmdGen.frx":64EA
         Height          =   375
         Index           =   5
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":682C
         Style           =   1  'Graphical
         TabIndex        =   94
         Top             =   975
         UseMaskColor    =   -1  'True
      ...
      End
      Begin VB.CommandButton cmdStart 
         DisabledPicture =   "frmAkClient_CmdGen.frx":6B6E
         Height          =   375
         Index           =   5
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":6EB0
         Style           =   1  'Graphical
         TabIndex        =   93
         Top             =   600
         UseMaskColor    =   -1  'True
   ...
   Begin VB.Frame Frame1 
      ...
      End
      Begin VB.CommandButton cmdStart 
         DisabledPicture =   "frmAkClient_CmdGen.frx":71F2
         Height          =   375
         Index           =   6
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":7534
         Style           =   1  'Graphical
         TabIndex        =   79
         Top             =   240
         UseMaskColor    =   -1  'True
      ...
      End
      Begin VB.CommandButton cmdStop 
         DisabledPicture =   "frmAkClient_CmdGen.frx":7876
         Height          =   375
         Index           =   6
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":7BB8
         Style           =   1  'Graphical
         TabIndex        =   78
         Top             =   615
         UseMaskColor    =   -1  'True
   ...
   Begin VB.Frame frmTemps 
      ...
      End
      Begin VB.CommandButton cmdStop 
         DisabledPicture =   "frmAkClient_CmdGen.frx":7EFA
         Height          =   375
         Index           =   3
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":823C
         Style           =   1  'Graphical
         TabIndex        =   54
         Top             =   615
         UseMaskColor    =   -1  'True
      ...
      End
      Begin VB.CommandButton cmdStart 
         DisabledPicture =   "frmAkClient_CmdGen.frx":857E
         Height          =   375
         Index           =   3
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":88C0
         Style           =   1  'Graphical
         TabIndex        =   53
         Top             =   240
         UseMaskColor    =   -1  'True
   ...
   Begin VB.TextBox txtMsg 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   51
      Text            =   "frmAkClient_CmdGen.frx":8C02
      Top             =   60
      Width           =   8175
   End
   Begin VB.CommandButton cmdStart 
      DisabledPicture =   "frmAkClient_CmdGen.frx":8C0A
      Height          =   375
      Index           =   4
      Left            =   18000
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":8F4C
      Style           =   1  'Graphical
      TabIndex        =   35
      Top             =   10095
      UseMaskColor    =   -1  'True
   ...
   End
   Begin VB.CommandButton cmdStop 
      DisabledPicture =   "frmAkClient_CmdGen.frx":928E
      Height          =   375
      Index           =   4
      Left            =   18840
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":95D0
      Style           =   1  'Graphical
      TabIndex        =   34
      Top             =   10095
      UseMaskColor    =   -1  'True
   ...
   End
   Begin VB.CommandButton cmdStop 
      DisabledPicture =   "frmAkClient_CmdGen.frx":9912
      Height          =   375
      Index           =   2
      Left            =   18840
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":9C54
      Style           =   1  'Graphical
      TabIndex        =   12
      Top             =   9480
      UseMaskColor    =   -1  'True
   ...
   End
   Begin VB.CommandButton cmdStart 
      DisabledPicture =   "frmAkClient_CmdGen.frx":9F96
      Height          =   375
      Index           =   2
      Left            =   18000
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":A2D8
      Style           =   1  'Graphical
      TabIndex        =   11
      Top             =   9480
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton cmdSend 
      Caption         =   "master"
      DisabledPicture =   "frmAkClient_CmdGen.frx":A61A
      DownPicture     =   "frmAkClient_CmdGen.frx":A95C
      Height          =   615
      Index           =   7
      Left            =   17895
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":AC9E
      Style           =   1  'Graphical
      TabIndex        =   44
      Top             =   3315
      UseMaskColor    =   -1  'True
   ...
   Begin VB.TextBox txtStatus 
      ...
      ScrollBars      =   3  'Both
      TabIndex        =   29
      Text            =   "frmAkClient_CmdGen.frx":AFE0
      Top             =   5160
      Width           =   7005
   End
   Begin VB.TextBox txtSend 
   ...
   Begin VB.CommandButton cmdDisconnect 
      ...
      Left            =   10560
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":AFEA
      Style           =   1  'Graphical
      TabIndex        =   17
      Top             =   60
      UseMaskColor    =   -1  'True
   ...
   Begin VB.TextBox txtStatus 
      ...
      ScrollBars      =   3  'Both
      TabIndex        =   5
      Text            =   "frmAkClient_CmdGen.frx":B32C
      Top             =   960
      Width           =   7005
   End
   Begin VB.CommandButton cmdConnect 
      ...
      Left            =   11640
      MaskColor       =   &H00FFFFFF&
      Picture         =   "frmAkClient_CmdGen.frx":B336
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   60
      UseMaskColor    =   -1  'True
   ...
   Begin VB.Frame frmControls 
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   5925
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":B678
         Style           =   1  'Graphical
         TabIndex        =   138
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":B9BA
         Style           =   1  'Graphical
         TabIndex        =   124
         Top             =   1485
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   2055
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":BCFC
         Style           =   1  'Graphical
         TabIndex        =   123
         Top             =   2100
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   2055
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":C03E
         Style           =   1  'Graphical
         TabIndex        =   122
         Top             =   1485
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":C380
         Style           =   1  'Graphical
         TabIndex        =   121
         Top             =   870
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   2055
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":C6C2
         Style           =   1  'Graphical
         TabIndex        =   120
         Top             =   870
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   2055
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":CA04
         Style           =   1  'Graphical
         TabIndex        =   119
         Top             =   255
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":CD46
         Style           =   1  'Graphical
         TabIndex        =   118
         Top             =   3330
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   120
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":D088
         Style           =   1  'Graphical
         TabIndex        =   117
         Top             =   255
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   2055
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":D3CA
         Style           =   1  'Graphical
         TabIndex        =   116
         Top             =   3330
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   5925
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":D70C
         Style           =   1  'Graphical
         TabIndex        =   115
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   5925
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":DA4E
         Style           =   1  'Graphical
         TabIndex        =   114
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   5925
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":DD90
         Style           =   1  'Graphical
         TabIndex        =   113
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   5925
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":E0D2
         Style           =   1  'Graphical
         TabIndex        =   112
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   2055
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":E414
         Style           =   1  'Graphical
         TabIndex        =   111
         Top             =   2715
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   3990
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":E756
         Style           =   1  'Graphical
         TabIndex        =   110
         Top             =   2715
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   3990
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":EA98
         Style           =   1  'Graphical
         TabIndex        =   109
         Top             =   1485
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   3990
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":EDDA
         Style           =   1  'Graphical
         TabIndex        =   108
         Top             =   870
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   3990
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":F11C
         Style           =   1  'Graphical
         TabIndex        =   107
         Top             =   255
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdSend 
         ...
         Left            =   3990
         MaskColor       =   &H00FFFFFF&
         Picture         =   "frmAkClient_CmdGen.frx":F45E
         Style           =   1  'Graphical
         TabIndex        =   106
         Top             =   2100
         UseMaskColor    =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmAkClient_CmdGen"
